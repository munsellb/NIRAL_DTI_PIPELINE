...
cmd = "WarpImageMultiTransform 3 "+arguments["MOV"]+" "+output+" -R "+ arguments["REF"]+" --use-NN -i " + arguments["OUT_ANTS_PREFIX"]+"Affine.txt " +arguments["OUT_ANTS_PREFIX"]+"InverseWarp.nii.gz"
